...
## হেডার wordmark — `app/layout.tsx`

"srdtube" + সাবটাইটেল একটা `<Link href="/">`, role class `.brand`
(hover-এ ম্লান হয়, জ্বলে না — খোদাই করা লেখা তো জ্বলে না)। বাড়ি মানে
Video Search; আলাদা ল্যান্ডিং পেজ নেই।
